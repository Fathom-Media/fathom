...
Fathom runs on **Linux** and **Windows** today, with a self-contained download for each. An **Android** app is planned. macOS and iOS are on the radar but need Mac hardware. See [Install](install.md) for details.
