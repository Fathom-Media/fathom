...
| --- | --- |
| **Stable** | Only full releases (for example `0.9.0`). The default. |
...
- **Stable releases** are plain versions like `0.9.0`.
- **Dev / Beta builds** are pre-releases named `0.9.1-dev07`, `0.9.1-dev08`, and so on. The Beta channel tracks these in order and rolls you onto the next stable release when it lands.
